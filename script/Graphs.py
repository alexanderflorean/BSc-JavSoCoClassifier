...
def plot_line_graph(title: str, x_axis, y_axis: dict, x_axis_name, y_axis_name, type:str):
    if type == "accuracy":
        ...
        ax1.scatter(x_axis, [x[0] for x in y_axis["naive"]], s=50, c="b", marker="x", label="Naive-Bayes")
        ax1.plot(x_axis, [x[0] for x in y_axis["naive"]], c="b")

        ax1.scatter(x_axis, [x[0] for x in y_axis["maxEnt"]], s=50, c="r", marker="x", label="MaxEnt")
        ax1.plot(x_axis, [x[0] for x in y_axis["maxEnt"]], c="r")

        ax1.scatter(x_axis, [x[0] for x in y_axis["svm"]], s=50, c="g", marker="x", label="SVM")
        ax1.plot(x_axis, [x[0] for x in y_axis["svm"]], c="g")
        ...
        ax1.scatter(x_axis, [x[1] for x in y_axis["naive"]], s=50, c="b", marker="x", label="Naive-Bayes")
        ax1.plot(x_axis, [x[1] for x in y_axis["naive"]], c="b")

        ax1.scatter(x_axis, [x[1] for x in y_axis["maxEnt"]], s=50, c="r", marker="x", label="MaxEnt")
        ax1.plot(x_axis, [x[1] for x in y_axis["maxEnt"]], c="r")

        ax1.scatter(x_axis, [x[1] for x in y_axis["svm"]], s=50, c="g", marker="x", label="SVM")
        ax1.plot(x_axis, [x[1] for x in y_axis["svm"]], c="g")
